...
<dt>业务</dt>
<dd>
<a class="global_gaNode" data-galabel="home_footer_nav_link" href="<?php echo FIX_HOST; ?>" rel="nofollow">手机服务</a>
<a class="global_gaNode" data-galabel="home_footer_nav_link" href="<?php echo LAB_HOST; ?>" rel="nofollow">实验室</a>
<a class="global_gaNode" data-galabel="home_footer_nav_link" href="<?php echo PLUS_HOST; ?>" rel="nofollow">社区</a>
</dd>
</dl>
<dl>
<dt>关于我们</dt>
...
<? if($seoTag!=''){ ?>
<?php $this->loadWidget('tagList', array('seoTag' => $seoTag), 'global'); ?>
<? } ?>

<div class="footer_message">
<div class="footer_pcMsg clear">
<div class="inner_copyr">
<img class="inner_lisense" src="<?php echo STATIC_HOST; ?>page/img/img_84258487f7_global_footer_lisence.png" />

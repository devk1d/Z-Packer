...
<div class="global_header {=isset($headType) ? $headType : 'bigHead'}">
		...
		<div class="account_wrap">
			<div class="header_account clear">
				<ul class="account_nav clear">
					...
					<li><a class="" href="{_PLUS_HOST}" target="_blank">社区</a></li>
					<li><a class="" href="{_PHONE_HOST}">手机工具</a></li>
					<li><a class="" href="{_FIX_HOST}" target="_blank">FIX</a></li>
					<li><a class="" href="{_PHONE_HOST}lab" target="_blank">实验室</a></li>
				</ul>
				...
				<div class="account_right clear">
					...
					<div class="inner_account">
						...
						<span class="account_user clear">
							<a class="img_link global_gaNode clear" data-galabel="home_header_user_img" href="/personal">
								<img class="user_img" src="{_STATIC_HOST}images/mb_pic30.gif" alt="会员头像" />
							</a>
							<span class="user_active {=isset($headType) ? $headType : 'bigHead'}">
					...
					<div class="inner_login" style="display:none">
						<a class="login_in global_gaNode" href="{_WWW_HOST}login/?from=index&redirect={$locationHref}" data-galabel="home_header_login">登录</a>
						<a class="logoutCss global_gaNode" href="{_WWW_HOST}reg?from=Index&redirect={$locationHref}" data-galabel="home_header_reg">注册</a>
					</div>
				...
				<ul class="inner_nav">
					...
					<li><a class="global_gaNode" href="{_PLUS_HOST}" target="_blank" data-galabel="home_header_nav_plus">社区</a></li> 
					<li><a class="global_gaNode" href="{_PHONE_HOST}" data-galabel="home_header_nav_phone">手机工具</a></li>
					<li><a class="global_gaNode" href="{_FIX_HOST}" target="_blank" data-galabel="home_header_nav_fix">FIX</a></li> 
					<li><a class="global_gaNode" href="{_PHONE_HOST}lab" target="_blank" data-galabel="home_header_nav_lab">实验室</a></li> 
...
<div class="msg_content">
	<h2>欢迎你!</h2>
	<a href="{_WWW_HOST}user?pagetype=setbasic" class="msg_btn_box">
		<img src='' id="msg_pic"/>
	</a>
	<div id="msg_name"></div>
	你与极客之间的距离，可能只差个性<br />的头像！快去完善吧~
	<a href="{_WWW_HOST}user?pagetype=setbasic" class="msg_btn msg_btn_box">完善资料</a>
</div>
</script>
...
<div class="global_mHeader">
	...
	<div class="mHeader_right">
		<a class="mHeader_login" href="{_WWW_HOST}mobile/login/?from=index&redirect={$locationHref}">登录</a>
	...
	<ul class="mHeader_menuList">
		...
		<li><a class="" href="{_PLUS_HOST}" target="_blank">社区</a></li>
		<li><a class="" href="{_PHONE_HOST}">手机工具</a></li>
		<li><a class="" href="{_FIX_HOST}" target="_blank">维修</a></li>
		<li><a class="" href="{_PHONE_HOST}lab" target="_blank">实验室</a></li>
...
<div class="global_appDownload">
	...
	<a href="{_APP_DOWNLOAD}" class="appDownload_btn">立即下载</a>
</div>
<?}?>
